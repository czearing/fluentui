...
// export const StackView: IStackComponent['view'] = props => {

export const StackView: React.FunctionComponent<IStackProps> = React.forwardRef<HTMLElement, IStackProps>(
  (props, ref) => {
    ...
    return (
      <Slots.root {...nativeProps} ref={ref}>
        {stackChildren}
      </Slots.root>
    );
  },
